...
Components/usb/usb.obj: ../Components/usb/usb.c $(GEN_OPTS) $(GEN_SRCS)
	...
	$(shell echo --silicon_errata=CPU22 >> "Components/usb/usb_ccsCompiler.opt")
	$(shell echo --silicon_errata=CPU21 >> "Components/usb/usb_ccsCompiler.opt")
	$(shell echo --silicon_errata=CPU23 >> "Components/usb/usb_ccsCompiler.opt")
	$(shell echo --silicon_errata=CPU40 >> "Components/usb/usb_ccsCompiler.opt")
