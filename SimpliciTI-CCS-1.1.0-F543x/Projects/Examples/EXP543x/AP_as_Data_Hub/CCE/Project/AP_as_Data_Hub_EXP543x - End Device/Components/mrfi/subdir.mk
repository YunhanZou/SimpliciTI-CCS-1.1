...
Components/mrfi/mrfi.obj: C:/Users/Ghaith/Desktop/eStadium/Wireless/SimpliciTI-CCS-1.1.0-F543x/Components/mrfi/mrfi.c $(GEN_OPTS) $(GEN_SRCS)
	...
	$(shell echo --silicon_errata=CPU22 >> "Components/mrfi/mrfi_ccsCompiler.opt")
	$(shell echo --silicon_errata=CPU21 >> "Components/mrfi/mrfi_ccsCompiler.opt")
	$(shell echo --silicon_errata=CPU23 >> "Components/mrfi/mrfi_ccsCompiler.opt")
	$(shell echo --silicon_errata=CPU40 >> "Components/mrfi/mrfi_ccsCompiler.opt")
