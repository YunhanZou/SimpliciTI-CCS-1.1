...
#define ACC_X_PIN   BIT4  //7.4
#define ACC_Y_PIN	BIT5  //7.5
#define ACC_Z_PIN	BIT6  //7.6
...
unsigned short BufferX[1216];
unsigned short BufferY[1216];
unsigned short BufferZ[1216];
...
void AccelerometerInit(void)
{
  ...
  ADC12CTL0 = ADC12ON + ADC12MSC + ADC12SHT0_9 ;// 
                 ...
                 do{
					...
					//	{
							...
							if(DMA_DONE){
									...
									msg = (char*)(BufferX+ (offset_msg>>1));
									UsbSendString(msg,76);  //
								...
								//	 __bis_SR_register(LPM0_bits + GIE); 
							          ...
							          i=(i+1)&0x0F; //circulate every 15 packets 
								}
